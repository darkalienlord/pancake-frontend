...
export const MULTICALL_ADDRESS: { [key in ChainId]?: Address } = {
  ...
  [ChainId.BLAST]: '0xAF90CB7191a86301b8703229f36c079e367A7757',
  ...
  [ChainId.BLAST_SEPOLIA]: '0x9E74fB28218EbD13FfC9e92d24A3926EC4cf9714',
}
...
export const MULTICALL3_ADDRESSES: {
  ...
  [ChainId.BLAST]: MULTICALL3_ADDRESS,
  [ChainId.BLAST_SEPOLIA]: MULTICALL3_ADDRESS,
}
