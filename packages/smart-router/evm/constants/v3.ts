...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.BLAST]: '0xe1454E04c86ef7cE564641d0B0BF23b1c3FBe7eD',
  [ChainId.BLAST_SEPOLIA]: '0x186f164a4dAc22242A888188dcD4724cED47a589',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.BLAST]: '0xE911bf55c0228e4F3b5d79179897361DBc5C578C',
  [ChainId.BLAST_SEPOLIA]: '0x9a989820771D4eB5e4ec3241d6c76761Fc6e15d6',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.BLAST]: TICK_LENS_MAINNET_ADDRESS,
  [ChainId.BLAST_SEPOLIA]: TICK_LENS_MAINNET_ADDRESS,
} as const satisfies Record<ChainId, Address>
