...
import { blastTokens } from './constants/blast'
import { blastSepoliaTokens } from './constants/blastSepolia'
...
export const allTokens = {
  ...
  [ChainId.BLAST]: blastTokens,
  [ChainId.BLAST_SEPOLIA]: blastSepoliaTokens,
}
