...
import PoolsBlastSepoliaPriceHelper from './pools/168587773'
...
import PoolsBlastPriceHelper from './pools/81457'
...
export const getPoolsPriceHelperLpFiles = (chainId: ChainId) => {
  switch (chainId) {
    ...
    case ChainId.BLAST:
      return PoolsBlastPriceHelper
    case ChainId.BLAST_SEPOLIA:
      return PoolsBlastSepoliaPriceHelper
    default:
      return []
  }
}
